...
constr_to_lvl = {
    ...
    "ctd_tsmb_radial_groove": {
        "dop": "Вставка цельная для радиальных канавок",
        "l1": "Резцы",
        "l2": "Микрорасточные цельные вставки",
        "l3": "Вставки для радиальных канавок",
    },
    "ctd_tsmb_thread": {
        "dop": "Вставка цельная резьбовая",
        "l1": "Резцы",
        "l2": "Микрорасточные цельные вставки",
        "l3": "Вставки резьбовые",
    },
    "ctd_rm1": {
        "dop": "Развертка цельная машинная концевая",
        "l1": "Развертки",
    },
    "ctd_arbm_drillingchuck": {
        "dop": "Патрон сверлильный",
        "l1": "Оснастка",
        "l2": "Сверлильные патроны"
    },
    "ctd_arb_bush": {
    ...
    "ctd_bs_arbor": {
        "dop": "Базовая оправка расточной системы",
        "l1": "Расточные системы",
        "l2": "Базовые оправки расточных систем",
    },
    "ctd_bs_carte": {
        "dop": "Нерегулируемый картридж для расточной системы",
        "l1": "Расточные системы",
        "l2": "Картриджи и резцы расточных систем",
        "l3": "Нерегулируемые картриджи для расточных систем",
    },
}
